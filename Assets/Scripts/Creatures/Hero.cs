using Scripts.Components.Projectiles;
...
namespace Scripts.Creatures
{
    public class Hero : MonoBehaviour, IMovable
    {
        ...
        private readonly Cooldown _cooldownShoot = new Cooldown();
        ...
        {
            var rayEndPoint = CameraController.Instance.MainCamera.ScreenToWorldPoint(new Vector3(mousePos.x, mousePos.y, 10f));
            var rayStartPoint = CameraController.Instance.MainCamera.transform.position;
